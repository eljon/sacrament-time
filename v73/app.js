...
(function () {
  ...
  function updateFly() {
    ...
    f.groups.forEach(function (g) {
      ...
      placeClone(g.monEl, g.sMon, g.tMon, g.monScale0 + (g.monScale1 - g.monScale0) * eP, eP);
      placeClone(g.dayEl, g.sDay, g.tDay, g.dayScale0 + (g.dayScale1 - g.dayScale0) * eP, eP);
    });
  }
  function placeClone(el, s, t, scale, eP) {
