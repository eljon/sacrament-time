...
ramp — **green** on time, easing to a **yellow-orange** at 5 minutes late and on
to full **red** at 10 — and the line is a gradient blending the start colour into
the end colour. The handles
