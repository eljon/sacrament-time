...
(function () {
  ...
  // ---- Tick sound -----------------------------------------------------------
  // A short "tick" clip played on every coverflow card-snap and picker notch — a
  // substitute now that iOS patched the Taptic switch trick. Uses an <audio>
  // element POOL rather than Web Audio: on iOS an <audio> element played once
  // inside a user gesture is then free to replay any time (including out of a
  // gesture, e.g. during coverflow momentum), whereas Web Audio's context-unlock
  // proved unreliable here (never audible across versions). The clip is an inline
  // data URI so the archived /vNN/ snapshots stay self-contained.
  var TICK_WAV = "data:audio/wav;base64,";
  var _tickPool = [], _tickIdx = 0, _tickReady = false;
  // "ambient": mix the tick with the user's music and play whenever the ringer is
  // on, without pausing other audio. (Silent mode still mutes it — OS behaviour.)
  ...
  function initTick() {
    ...
    for (var i = 0; i < 6; i++) {
      ...
      a.preload = "auto"; a.volume = 0.55;   // honoured off-iOS; iOS plays at system level
      _tickPool.push(a);
    }
  }
  // Bless the pool inside the first user gesture: a muted play→pause marks each
  // element as user-initiated, so later ticks are allowed to sound.
  function unlockTick() {
    setAudioSession();
    if (_tickReady || !_tickPool.length) return;
    _tickReady = true;
    _tickPool.forEach(function (a) {
      a.muted = true;
      try {
        var p = a.play();
        if (p && p.then) p.then(function () { a.pause(); a.currentTime = 0; a.muted = false; }, function () { a.muted = false; });
        else { a.pause(); a.currentTime = 0; a.muted = false; }
      } catch (e) { a.muted = false; }
    });
  }
  function tick() {
    if (!_tickPool.length) return;
    var a = _tickPool[_tickIdx];
    _tickIdx = (_tickIdx + 1) % _tickPool.length;   // round-robin so fast ticks don't cut each other off
    try { a.muted = false; a.currentTime = 0; var p = a.play(); if (p && p.catch) p.catch(function () {}); } catch (e) {}
  }
  ...
  function init() {
    initHaptics();
    initTick();
    // Unlock the tick pool on the first touch, and warm the Taptic engine once —
    // all silently, so a stray first tap doesn't tick. Bind pointerdown AND touch
    // events since iOS is picky about which gesture "activates" media playback.
