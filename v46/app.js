...
(function () {
  ...
  // the centre card sits biggest (1.1×) and cards shrink progressively the
  // farther out they are, so the current week stands out.
  function cardScale(ao) { return Math.max(0.6, 1.1 - 0.10 * ao); }
