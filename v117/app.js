...
(function () {
  ...
  // iOS silences Web Audio whenever the ring/silent switch is set to silent,
  // UNLESS the page declares a "playback" audio session (the category that plays
  // over silent mode). Without this the tick is inaudible on a silenced phone no
  // matter how it's unlocked — which is why it never sounded. Trade-off: playback
  // can pause other apps' audio, acceptable for a brief UI tick.
  ...
  function unlockAudio() {
    ...
    setPlaybackSession();                                       // (re)assert inside the gesture
