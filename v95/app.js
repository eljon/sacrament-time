...
(function () {
  ...
  // hidden <input switch> via its <label>, which fires the system tick on iOS 17.4+.
  var _hapticLabel = null;
  function initHaptics() {
    var wrap = document.createElement("span");
    wrap.setAttribute("aria-hidden", "true");
    wrap.style.cssText = "position:absolute;left:-9999px;top:0;width:1px;height:1px;overflow:hidden;opacity:0;pointer-events:none";
    var input = document.createElement("input");
    input.type = "checkbox"; input.id = "_hapticSwitch"; input.setAttribute("switch", "");
    var label = document.createElement("label"); label.setAttribute("for", "_hapticSwitch");
